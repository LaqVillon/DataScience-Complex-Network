"""
Este codigo calcula o strength da rede para cada mês de 2001.
...
def print_strength_meses(data: dict) -> None:
    file_path = "Strength/strength_2001.txt"
    if os.path.exists(file_path) == False:    
        for mes in range(1,13):
            ...
            with open('Strength/strength_2001.txt', 'a+') as f:
                f.write('""------------------------------------ Mês:  ')
                f.write(str(mes))
                f.write(' --------------------------""\n')
...
# # ------------------------------------ Leitura de dados ------------------------------------
G1 = nx.DiGraph()
with open('Dataset/2001/2001_janeiro_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
...
G2 = nx.DiGraph()
with open('Dataset/2001/2001_fevereiro_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G3 = nx.DiGraph()
with open('Dataset/2001/2001_março_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G4 = nx.DiGraph()
with open('Dataset/2001/2001_abril_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G5 = nx.DiGraph()
with open('Dataset/2001/2001_maio_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G6 = nx.DiGraph()
with open('Dataset/2001/2001_junho_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G7 = nx.DiGraph()
with open('Dataset/2001/2001_julho_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G8 = nx.DiGraph()
with open('Dataset/2001/2001_agosto_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G10 = nx.DiGraph()
with open('Dataset/2001/2001_outubro_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G11 = nx.DiGraph()
with open('Dataset/2001/2001_novembro_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
...
G12 = nx.DiGraph()
with open('Dataset/2001/2001_dezembro_arestas_peso_atualizado.csv', 'r') as edgecsv: # Open the file
    edgereader = csv.reader(edgecsv)  # Read the csv
    edges = [e for e in edgereader][0:]
edges2 = []
aresta2 = ()
